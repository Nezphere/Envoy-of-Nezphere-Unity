...
namespace VrInput {
	public abstract class VrPointer : MonoBehaviour {
		...
		protected virtual void Start() {
			if (VrPointerInputModule.Instance == null) {
				new GameObject().AddComponent<VrPointerInputModule>();
			}

			VrPointerInputModule.Instance.AddController(this);
		}

		protected virtual void OnDestroy() {
			if (VrPointerInputModule.Instance != null)
				VrPointerInputModule.Instance.RemoveController(this);
		}
