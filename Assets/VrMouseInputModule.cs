...
public class VrMouseInputModule : PointerInputModule {
	...
	protected override MouseState GetMousePointerEventData(int id) {
		...
		var screenSpaceCursorPosition = new Vector2(UnityEngine.XR.XRSettings.eyeTextureWidth, UnityEngine.XR.XRSettings.eyeTextureHeight) * 0.5f;
		//Input.mousePosition / UnityEngine.XR.XRSettings.eyeTextureHeight * Camera.main.pixelHeight;//RectTransformUtility.WorldToScreenPoint(m_canvasCamera, m_VirtualCursor.position);
